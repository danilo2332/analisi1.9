...
public class Addendum extends BaseObject
{
    ...
    private Addendum(String addendumId, String weekOf, Date publishDate, int agendaNo, int year)
    {
     ...
     */
    public final void setAddendumId(String addendumId)
    {
     ...
     */
    public final void setWeekOf(String weekOf)
    {
        this.weekOf = weekOf;
    }
